...
LoxyCraft 1.10.1 improves the Unbreakable infusion by making it compatible with any item that has durability, including vanilla and modded items.

### Fixed

* Fixed the Unbreakable infusion being limited to specific equipment types
* Fixed damageable modded items not being able to receive the Unbreakable infusion
* Fixed non-damageable items so they are now correctly refused by the Unbreakable infusion

### Improved

* Improved Unbreakable infusion compatibility
* Improved the Unbreakable infusion so it can now be applied to any item with durability
* Improved support for vanilla tools, weapons, armor, bows, shields, Elytra, and other damageable items
* Improved support for compatible modded items with durability

### Notes

* The Unbreakable infusion only applies to items with durability
* Blocks, resources, food, cores, and other non-damageable items are not valid targets
* Already infused items cannot receive the same Unbreakable infusion again
